...
def get_train_data():
    ...
    a = pd.read_hdf('../data/semeval14/restaurants_train_data_processed.h5', 'table')
    ...
    print(a['polarity'][8])
    print(a['aspect'][8])
    a.to_hdf('../data/semeval14/train_data_3classes.h5', 'table')
...
def get_test_data():
    ...
    a = pd.read_hdf('../data/semeval14/restaurants_test_data_processed.h5', 'table')
    a['text'] = a['text'].apply(ast.literal_eval)
    # shuffle dataset
    a = a.sample(frac=1).reset_index(drop=True)
    lens = []
    ...
    print("\n\n", a['text'][8])
    print(a['aspect'][8])
    a.to_hdf('../data/semeval14/test_data_3classes.h5', 'table')
